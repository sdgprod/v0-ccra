...
const formSteps = [
  ...
  { id: "sanction", label: "Sanction & KYC" },
...
const customerData = {
  ...
  "metro-commodities": {
    ...
    country: "Vietnam",
    businessRelationship: "4",
    currentCreditLimit: "800000",
...
export default function CreditRequestPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    proposedCreditLimit: "",
    additionalNotes: "",
    // </CHANGE> Added assessment fields
    creditScore: "85",
    riskRating: "B+",
            ...
            <Card className="p-6">
              ...
              {activeStep === "basic" && (
                <div className="space-y-6">
                              ...
                              customer?.country === "Singapore"
                                ...
                                : customer?.country === "Malaysia"
                                  ...
                                  : customer?.country === "Thailand"
                                    ? "THB"
                                    : "USD", // Auto-set currency based on country
                          })
                        }}
                      >
                  ...
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="businessRelationship">Business Relationship (Years)</Label>
                      <Input
                        id="businessRelationship"
                        type="number"
                        placeholder="10"
                        value={formData.businessRelationship}
                        onChange={(e) => setFormData({ ...formData, businessRelationship: e.target.value })}
                      />
                    </div>
                  </div>
                  {/* </CHANGE> */}
                    ...
                    <div className="space-y-6 mt-8">
                      ...
                      <div className="border rounded-lg p-6">
                        ...
                        <div className="grid grid-cols-4 gap-4 mt-6 pt-6 border-t">
                          ...
                          <div className="text-center">
                            <div className="text-2xl font-bold text-green-600">{selectedCustomerData.onTimeRate}%</div>
              ...
              {activeStep === "assessment" && (
                <div className="space-y-8">
                  <div>
                    <h2 className="text-2xl font-bold">Credit Assessment & Risk Analysis</h2>
                  </div>

                  {/* Credit Score and Risk Rating */}
                  <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="creditScore">Credit Score (/100)</Label>
                      <Input
                        id="creditScore"
                        type="number"
                        placeholder="85"
                    ...
                    <div>
                      ...
                      <Input id="riskRating" value={formData.riskRating} readOnly className="text-lg bg-muted" />
                      <p className="text-xs text-muted-foreground mt-1">Auto-calculated based on credit assessment</p>
                    </div>
                    {/* </CHANGE> */}
                  </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-3 gap-6">
                      <div className="space-y-2">
                        <Label htmlFor="profitabilityRatio">Profitability Ratio (%)</Label>
                        <Input
                          id="profitabilityRatio"
                          type="number"
                          step="0.1"
                          placeholder="6.2"
                          value={formData.profitabilityRatio}
                          onChange={(e) => setFormData({ ...formData, profitabilityRatio: e.target.value })}
                          className="text-lg"
                        />
                      </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setFormData({ ...formData, currentRatio: e.target.value })}
                          className="text-lg"
                        />
                      </div>

                      <div className="space-y-2">
                        <Label htmlFor="gearingRatio">Gearing Ratio</Label>
                        <Input
                          id="gearingRatio"
                          type="number"
                          step="0.1"
                          placeholder="1.2"
                          value={formData.gearingRatio}
                          onChange={(e) => setFormData({ ...formData, gearingRatio: e.target.value })}
                          className="text-lg"
                        />
                      </div>
                    </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      <div className="text-center p-6 bg-blue-50 rounded-lg border border-blue-200">
                        <div className="text-3xl font-bold text-blue-600 mb-2">{formData.creditScore}/100</div>
                        <div className="text-sm text-muted-foreground">Credit Score</div>
                      </div>

                      <div className="text-center p-6 bg-green-50 rounded-lg border border-green-200">
                        <div className="text-3xl font-bold text-green-600">{formData.riskRating}</div>
                        <div className="text-sm text-muted-foreground">Risk Rating</div>
                      </div>

                      <div className="text-center p-6 bg-purple-50 rounded-lg border border-purple-200">
                        <div className="text-3xl font-bold text-purple-600">{formData.profitabilityRatio}%</div>
                        <div className="text-sm text-muted-foreground">Profitability</div>
                      </div>

                      <div className="text-center p-6 bg-orange-50 rounded-lg border border-orange-200">
                        <div className="text-3xl font-bold text-orange-600">{formData.currentRatio}</div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      id="assessmentNotes"
                      placeholder="Add assessment notes, observations, or additional risk factors..."
                      rows={6}
                    ...
                    <div className="border-2 border-dashed border-muted-foreground/25 rounded-lg p-12 text-center hover:border-muted-foreground/50 transition-colors cursor-pointer">
                      ...
                      <label htmlFor="supportingDocuments" className="cursor-pointer">
                        ...
                        <div className="text-sm text-muted-foreground">
                          Upload financial statements, D&B reports, purchase orders, etc.
                        </div>
                      </label>
                    </div>
                        ...
                        {formData.supportingDocuments.map((file, index) => (
                          <div key={index} className="flex items-center gap-2 p-2 bg-muted rounded">
                            ...
                            <Button
                              ...
                              size="sm"
                              onClick={() => {
                                const newFiles = formData.supportingDocuments.filter((_, i) => i !== index)
                                setFormData({ ...formData, supportingDocuments: newFiles })
                              }}
                            >
                              Remove
                            </Button>
                  ...
                  <div className="border rounded-lg p-6 bg-blue-50/50">
                    <h3 className="text-lg font-bold mb-3">Assessment Recommendation</h3>
                    <div className="flex items-start gap-3 mb-4">
                      <div className="h-6 w-6 rounded-full bg-green-600 flex items-center justify-center flex-shrink-0 mt-0.5">
                        <Check className="h-4 w-4 text-white" />
                      </div>
                      <div className="font-semibold text-green-900">RECOMMEND APPROVAL</div>
                    </div>
                    <p className="text-blue-900 leading-relaxed">
                      Based on the credit assessment, Global Foods Ltd demonstrates strong financial position with
                      excellent payment history. The requested credit increase is justified by business growth and order
                      requirements.
                    </p>
                  </div>
                </div>
                    ...
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-2 gap-6">
                        ...
                        <div>
                          ...
                          <p className="font-medium mt-1">
                            {formData.currentPaymentTerms || selectedCustomerData?.paymentTerms || "N/A"}
                          </p>
                        </div>
                      </div>
                      <div>
